...
export const cs = {
  ...
  form: {
    ...
    source: 'Zdroj',
    sourcePlaceholder: 'např. 1Mo 7,11',
    note: 'Poznámka',
    linkHint: 'Odkaz se píše jako [text](https://adresa) — v detailu i v tabulce z něj bude klikací „text“. Samotná adresa se zaktivní i bez závorek.',
    place: 'Místo',
